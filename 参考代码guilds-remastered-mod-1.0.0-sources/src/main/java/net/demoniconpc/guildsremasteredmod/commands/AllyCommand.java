...
public class AllyCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal((String)"ally").then(CommandManager.literal((String)"chat").then(CommandManager.argument((String)"guildName", (ArgumentType)StringArgumentType.word()).executes(ctx -> {
            ...
            boolean selfPvpDisabled = Boolean.TRUE.equals(self.getAllies().getOrDefault((Object)targetShort, (Guild.AllyInfo)new Guild.AllyInfo((String)"UNKNOWN", (boolean)false)).pvpDisabled);
            boolean targetPvpDisabled = Boolean.TRUE.equals(target.getAllies().getOrDefault((Object)selfShort, (Guild.AllyInfo)new Guild.AllyInfo((String)"UNKNOWN", (boolean)false)).pvpDisabled);
            if (selfPvpDisabled && targetPvpDisabled) {
                MutableText confirmButton = Text.literal((String)"[YES]").setStyle(Style.EMPTY.withColor(Formatting.field_1061).withClickEvent((ClickEvent)new ClickEvent.class_10609("/ally pvpdisableconfirm " + String.valueOf(target.getId()))).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to enable PvP"))));
                MutableText cancelButton = Text.literal((String)"[NO]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild cancel")).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to cancel"))));
                player.sendMessage((Text)Text.literal((String)"PvP with ").append((Text)Text.literal((String)target.getName()).formatted(Formatting.field_1075)).append((Text)Text.literal((String)" is currently DISABLED. Do you want to re-enable it? ")).append((Text)confirmButton).append((Text)Text.literal((String)" ")).append((Text)cancelButton), false);
                return 1;
            }
            ...
            player.sendMessage((Text)Text.literal((String)("PvP request sent to " + target.getName())).formatted(Formatting.field_1060), false);
            MutableText accept = Text.literal((String)"[ACCEPT]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/ally pvpenableaccept " + String.valueOf(self.getId()))).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to accept the PvP request"))));
            MutableText deny = Text.literal((String)"[DENY]").setStyle(Style.EMPTY.withColor(Formatting.field_1061).withClickEvent((ClickEvent)new ClickEvent.class_10609("/ally pvpenabledeny " + String.valueOf(self.getId()))).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to deny the PvP request"))));
            ...
            ((ServerCommandSource)ctx.getSource()).sendFeedback(() -> Text.literal((String)"PvP DISABLED between guilds.").formatted(Formatting.field_1060), false);
            return 1;
            ...
            UUID receiverId = player.getUuid();
            GuildDataManager.clearPvpRequest(receiverId);
            ((ServerCommandSource)ctx.getSource()).sendFeedback(() -> Text.literal((String)"PvP DISABLED request denied.").formatted(Formatting.field_1061), false);
            return 1;
            ...
            ((ServerCommandSource)ctx.getSource()).sendFeedback(() -> Text.literal((String)"PvP has been RE-ENABLED for both guilds.").formatted(Formatting.field_1061), false);
            return 1;
        }))));
    }
}
