 ...
 */
package net.demoniconpc.guildsremasteredmod.commands;
...
public class GuildCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)CommandManager.literal((String)"guild").then(CommandManager.literal((String)"create").then(CommandManager.argument((String)"name", (ArgumentType)StringArgumentType.word()).then(CommandManager.argument((String)"color", (ArgumentType)StringArgumentType.word()).executes(ctx -> {
            ...
            MutableText yesButton = Text.literal((String)"[YES]").setStyle(Style.EMPTY.withColor(Formatting.field_1061).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild disbandconfirm")).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to disband your guild"))));
            MutableText noButton = Text.literal((String)"[NO]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild cancel")).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to cancel"))));
            player.sendMessage((Text)Text.literal((String)"Are you sure you want to disband your guild? ").formatted(Formatting.field_1054).append((Text)yesButton).append((Text)Text.literal((String)" ")).append((Text)noButton), false);
            return 1;
            ...
            for (String allyShortId : guild.getAllies().keySet()) {
                ...
                for (UUID memberId : allyGuild.getMembers().keySet()) {
                    ...
                    allyPlayer.sendMessage((Text)Text.literal((String)"Your ally ").append((Text)Text.literal((String)disbandedName).formatted(Formatting.field_1075)).append((Text)Text.literal((String)" has disbanded and is no longer an ally.")));
                }
            }
            ...
            source.sendFeedback(() -> Text.literal((String)"Guild ").append((Text)Text.literal((String)guild.getName()).formatted(Formatting.field_1061)).append(" has been disbanded."), false);
            return 1;
            ...
            inviter.sendMessage((Text)Text.literal((String)("Invitation sent to " + target.getName().getString())).formatted(Formatting.field_1060));
            MutableText acceptButton = Text.literal((String)"[ACCEPT]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild accept")).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to join the guild"))));
            target.sendMessage((Text)Text.literal((String)"You have been invited to join the guild ").append((Text)Text.literal((String)guild.getName()).formatted(Formatting.field_1075)).append((Text)Text.literal((String)". ")).append((Text)acceptButton), false);
            ...
            source.sendFeedback(() -> Text.literal((String)"You have joined the guild ").append((Text)Text.literal((String)guild.getName()).formatted(Formatting.field_1075)).append("!"), false);
            if (guild.getMotd() != null && !guild.getMotd().isEmpty()) {
                player.sendMessage((Text)Text.literal((String)"Guild MOTD: ").append((Text)Text.literal((String)guild.getMotd()).styled(style -> style.withColor(Formatting.field_1075).withItalic(Boolean.valueOf(true)))), false);
            }
            ...
            player.sendMessage((Text)Text.literal((String)("You have left the guild " + guild.getName())).formatted(Formatting.field_1054));
            for (UUID memberId : guild.getMembers().keySet()) {
                ServerPlayerEntity member = server.getPlayerManager().getPlayer(memberId);
                if (member == null) continue;
                member.sendMessage((Text)Text.literal((String)(playerName + " has left the guild.")).formatted(Formatting.field_1080));
            }
            return 1;
            ...
            if (kicked != null) {
                ...
                kicked.sendMessage((Text)Text.literal((String)("You have been kicked from the guild " + guild.getName())).formatted(Formatting.field_1061));
                server.getCommandManager().executeWithPrefix(server.getCommandSource(), "team leave " + kickedName);
            }
            for (UUID memberId : guild.getMembers().keySet()) {
                ServerPlayerEntity member = server.getPlayerManager().getPlayer(memberId);
                if (member == null) continue;
                member.sendMessage((Text)Text.literal((String)(kickedName + " has been kicked from the guild.")).formatted(Formatting.field_1080));
            }
            return 1;
            ...
            if (enabled) {
                player.sendMessage((Text)Text.literal((String)"\ud83d\udfe2 Guild Chat Enabled! ").formatted(Formatting.field_1060).append((Text)Text.literal((String)"Your messages will now only go to your guild.")).formatted(Formatting.field_1080), false);
            } else {
                player.sendMessage((Text)Text.literal((String)"\ud83d\udd34 Guild Chat Disabled. ").formatted(Formatting.field_1061).append((Text)Text.literal((String)"You're now talking in global chat.")).formatted(Formatting.field_1080), false);
            }
            return 1;
            ...
            switch (currentRank = targetInfo.rank.toLowerCase()) {
                case "initiate": {
                    String string = "Member";
                    break;
                }
                case "member": {
                    String string = "Officer";
                    break;
                }
                default: {
                    String string = newRank = null;
                }
            }
            if (newRank == null) {
            ...
            source.sendFeedback(() -> Text.literal((String)(finalTargetInfo.name + " has been promoted to " + newRank + ".")), false);
            return 1;
            ...
            GuildDataManager.saveGuild(server, guild);
            Guild.GuildMemberInfo finalTargetInfo = targetInfo;
            source.sendFeedback(() -> Text.literal((String)(finalTargetInfo.name + " has been demoted to " + newRank + ".")), false);
            return 1;
            ...
            source.sendFeedback(() -> Text.literal((String)"Friendly fire has been ").append((Text)Text.literal((String)(!current ? "enabled" : "disabled")).formatted(!current ? Formatting.field_1060 : Formatting.field_1061)), true);
            return 1;
            ...
            guild.setMotd(motd);
            GuildDataManager.saveGuild(source.getServer(), guild);
            source.sendFeedback(() -> Text.literal((String)"Guild MOTD updated to: ").append((Text)Text.literal((String)motd).styled(style -> style.withColor(Formatting.field_1075))), false);
            return 1;
            ...
            for (String allyShortId : guild.getAllies().keySet()) {
                ...
                for (UUID memberId : allyGuild.getMembers().keySet()) {
                    ServerPlayerEntity allyPlayer = server.getPlayerManager().getPlayer(memberId);
                    if (allyPlayer == null) continue;
                    allyPlayer.sendMessage((Text)Text.literal((String)"Your ally ").append((Text)Text.literal((String)oldName).formatted(Formatting.field_1060)).append((Text)Text.literal((String)" has changed its name to ")).append((Text)Text.literal((String)newName).formatted(Formatting.field_1060)).append((Text)Text.literal((String)".")));
                }
            }
            String teamName = "guild_" + guild.getId().toString().substring(0, 8);
            ServerScoreboard scoreboard = server.getScoreboard();
            ...
            RegistryKey worldKey = RegistryKey.of((RegistryKey)RegistryKeys.WORLD, (Identifier)Identifier.of((String)parts[0], (String)parts[1]));
            ...
            player.sendMessage((Text)Text.literal((String)("Teleporting to your guild home in " + delaySeconds + " seconds...")).formatted(Formatting.field_1065), false);
            DelayedTeleportScheduler.schedule(player, delayTicks, () -> {
                if (player.isAlive() && player.getWorld() != null) {
                    player.teleport(world, guild.getHomeX(), guild.getHomeY(), guild.getHomeZ(), EnumSet.noneOf(PositionFlag.class), player.getYaw(), player.getPitch(), false);
                    player.sendMessage((Text)Text.literal((String)"You have arrived at your guild home.").formatted(Formatting.field_1060), false);
                }
            });
            return 1;
            ...
            if (senderGuild.getAllies().containsKey(targetShortId)) {
                MutableText yesButton = Text.literal((String)"[YES]").setStyle(Style.EMPTY.withColor(Formatting.field_1061).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild allyrevoke " + targetShortId)).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to revoke alliance"))));
                MutableText noButton = Text.literal((String)"[NO]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild cancel")).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to cancel"))));
                sender.sendMessage((Text)Text.literal((String)"You are already allied with ").append((Text)Text.literal((String)targetGuild.getName()).formatted(Formatting.field_1075)).append((Text)Text.literal((String)". Do you want to revoke this alliance? ")).append((Text)yesButton).append((Text)Text.literal((String)" ")).append((Text)noButton), false);
                return 0;
            }
            ...
            sender.sendMessage((Text)Text.literal((String)("Alliance request sent to " + targetGuild.getName())).formatted(Formatting.field_1060), false);
            MutableText acceptButton = Text.literal((String)"[ACCEPT]").setStyle(Style.EMPTY.withColor(Formatting.field_1060).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild allyaccept " + String.valueOf(senderGuild.getId()))).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to accept the alliance"))));
            MutableText denyButton = Text.literal((String)"[DENY]").setStyle(Style.EMPTY.withColor(Formatting.field_1061).withClickEvent((ClickEvent)new ClickEvent.class_10609("/guild allydeny " + String.valueOf(senderGuild.getId()))).withHoverEvent((HoverEvent)new HoverEvent.class_10613((Text)Text.literal((String)"Click to deny the alliance"))));
            targetMaster.sendMessage((Text)Text.literal((String)"Your guild has received an alliance request from ").append((Text)Text.literal((String)senderGuild.getName()).formatted(Formatting.field_1075)).append((Text)Text.literal((String)". ")).append((Text)acceptButton).append((Text)Text.literal((String)" ")).append((Text)denyButton), false);
            return 1;
            ...
            player.sendMessage((Text)Text.literal((String)("You are now allied with " + requesterGuild.getName() + "!")).formatted(Formatting.field_1060), false);
            ServerPlayerEntity requesterMaster = server.getPlayerManager().getPlayer(requesterGuild.getOwnerId());
            if (requesterMaster != null) {
                requesterMaster.sendMessage((Text)Text.literal((String)("Your alliance request was accepted by " + receiverGuild.getName() + "!")).formatted(Formatting.field_1060), false);
            }
            return 1;
            ...
            player.sendMessage((Text)Text.literal((String)"You have denied the alliance request from ").append((Text)Text.literal((String)senderGuild.getName()).formatted(Formatting.field_1061)));
            ServerPlayerEntity senderPlayer = server.getPlayerManager().getPlayer(senderGuild.getOwnerId());
            if (senderPlayer != null) {
                senderPlayer.sendMessage((Text)Text.literal((String)"Your alliance request to ").append((Text)Text.literal((String)receiverGuild.getName()).formatted(Formatting.field_1061)).append((Text)Text.literal((String)" was denied.")));
            }
            return 1;
            ...
            player.sendMessage((Text)Text.literal((String)"You have revoked your alliance with ").append((Text)Text.literal((String)targetGuild.getName()).formatted(Formatting.field_1061)));
            ServerPlayerEntity targetOwner = server.getPlayerManager().getPlayer(targetGuild.getOwnerId());
            if (targetOwner != null) {
                targetOwner.sendMessage((Text)Text.literal((String)(selfGuild.getName() + " has revoked their alliance with your guild.")).formatted(Formatting.field_1080));
            }
            return 1;
            ...
            if (!hand.isOf(Items.field_22020)) {
            ...
            if (newProgress >= cost) {
                ...
                for (UUID memberId : guild.getMembers().keySet()) {
                    ServerPlayerEntity member = server.getPlayerManager().getPlayer(memberId);
                    if (member == null) continue;
                    member.sendMessage((Text)Text.literal((String)("\u00a7aYour guild has unlocked Bank Tab " + nextTab + "!")).formatted(Formatting.field_1060));
                }
            }
            return 1;
            ...
            ((ServerCommandSource)ctx.getSource()).getPlayer().sendMessage((Text)Text.literal((String)"Action cancelled.").formatted(Formatting.field_1080));
            return 1;
        })));
    }
    ...
    private static void displayGuildInfo(MinecraftServer server, ServerCommandSource source, Guild guild) {
        ...
        source.sendMessage((Text)Text.literal((String)"Guild Home Set: ").formatted(Formatting.field_1065).append((Text)Text.literal((String)String.valueOf(hasHome)).formatted(hasHome ? Formatting.field_1060 : Formatting.field_1061)));
        source.sendMessage((Text)Text.literal((String)"Created: ").append((Text)Text.literal((String)guild.getFormattedDate()).formatted(Formatting.field_1068)));
        source.sendMessage((Text)Text.literal((String)"Guild Master: ").append((Text)Text.literal((String)guild.getOwnerName()).formatted(Formatting.field_1065)));
        source.sendMessage((Text)Text.literal((String)("Members (" + guild.getMembers().size() + "):")));
        ArrayList<CallSite> online = new ArrayList<CallSite>();
        ArrayList<CallSite> offline = new ArrayList<CallSite>();
        for (Map.Entry<UUID, Guild.GuildMemberInfo> entry : guild.getMembers().entrySet()) {
            UUID memberId = entry.getKey();
            Guild.GuildMemberInfo info = entry.getValue();
            ...
            if (player != null) {
                online.add((CallSite)((Object)display));
                continue;
            }
            offline.add((CallSite)((Object)display));
        }
        if (!online.isEmpty()) {
            source.sendMessage((Text)Text.literal((String)"Online:").formatted(Formatting.field_1060));
            for (String string : online) {
                source.sendMessage((Text)Text.literal((String)string).formatted(Formatting.field_1060));
            }
        }
        if (!offline.isEmpty()) {
            source.sendMessage((Text)Text.literal((String)"Offline:").formatted(Formatting.field_1061));
            for (String string : offline) {
                source.sendMessage((Text)Text.literal((String)string).formatted(Formatting.field_1061));
            }
        }
        if (!guild.getAllies().isEmpty()) {
            Collection<Guild.AllyInfo> allyInfos = guild.getAllies().values();
            MutableText class_52502 = Text.literal((String)"Allies: ").formatted(Formatting.field_1065);
            boolean first = true;
            for (Guild.AllyInfo ally : allyInfos) {
                if (!first) {
                    class_52502.append((Text)Text.literal((String)", ").formatted(Formatting.field_1080));
                }
                MutableText nameText = Text.literal((String)ally.name).formatted(Formatting.field_1060);
                nameText = ally.pvpDisabled ? nameText.append((Text)Text.literal((String)" (PvP Off)").formatted(Formatting.field_1061)) : nameText.append((Text)Text.literal((String)" (PvP On)").formatted(Formatting.field_1077));
                class_52502.append((Text)nameText);
                first = false;
            }
            source.sendMessage((Text)class_52502);
        } else {
            MutableText noAllies = Text.literal((String)"").append((Text)Text.literal((String)"Allies: ").formatted(Formatting.field_1065)).append((Text)Text.literal((String)"N/A").formatted(Formatting.field_1061));
