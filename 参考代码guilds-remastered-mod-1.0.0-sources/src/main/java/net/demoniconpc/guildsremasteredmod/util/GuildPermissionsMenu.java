...
import net.demoniconpc.guildsremasteredmod.util.GuildBankRankEditorMenu;
import net.demoniconpc.guildsremasteredmod.util.GuildMembersMenu;
import net.demoniconpc.guildsremasteredmod.util.GuildRankEditorMenu;
...
public class GuildPermissionsMenu {
    public static final List<PositionedMenuItem> MENU_ITEMS = List.of(new PositionedMenuItem(10, GuildPermissionsMenu.menuItem(Items.field_8407, "\u00a7eGuild Info", "/guild info")), new PositionedMenuItem(12, GuildPermissionsMenu.menuItem(Items.CHEST, "\u00a7bGuild Bank", "/guild bank 1")), new PositionedMenuItem(14, GuildPermissionsMenu.menuItem(Items.WHITE_BED, "\u00a7dSet Guild Home", "/guild sethome")), new PositionedMenuItem(16, GuildPermissionsMenu.menuItem(Items.field_8371, "\u00a76Toggle Friendly Fire", "/guild toggle_friendlyfire")), new PositionedMenuItem(28, GuildPermissionsMenu.menuItem(Items.PLAYER_HEAD, "\u00a7aManage Members", null)), new PositionedMenuItem(30, GuildPermissionsMenu.menuItem(Items.field_8448, "\u00a7bEdit Ranks", null)), new PositionedMenuItem(32, GuildPermissionsMenu.menuItem(Items.ENDER_CHEST, "\u00a79Bank Permissions", null)), new PositionedMenuItem(34, GuildPermissionsMenu.menuItem(Items.BARRIER, "\u00a7cDisband Guild", "/guild disband")));
    ...
    extends GenericContainerScreenHandler {
        ...
        public GuildPermissionsMenuHandler(int syncId, PlayerInventory playerInventory, SimpleInventory menuInventory) {
            super(ScreenHandlerType.field_17327, syncId, playerInventory, (Inventory)menuInventory, 6);
