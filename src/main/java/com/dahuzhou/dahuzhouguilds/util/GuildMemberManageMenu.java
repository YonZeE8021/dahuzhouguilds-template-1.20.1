...
public class GuildMemberManageMenu {
    public static void openForPlayer(ServerPlayerEntity player, UUID memberId) {
        ...
        inventory.setStack(11, GuildPermissionsMenu.menuItem(Items.EMERALD, "Promote", "/guild promote " + memberName).icon.copy());
        inventory.setStack(13, GuildPermissionsMenu.menuItem(Items.IRON_SWORD, "Kick", "/guild kick " + memberName).icon.copy());
        inventory.setStack(15, GuildPermissionsMenu.menuItem(Items.BARRIER, "Demote", "/guild demote " + memberName).icon.copy());
