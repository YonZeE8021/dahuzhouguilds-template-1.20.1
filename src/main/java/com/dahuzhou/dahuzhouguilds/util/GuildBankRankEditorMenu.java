...
import com.dahuzhou.dahuzhouguilds.util.GuildBankRankPermissionsMenu;
...
public class GuildBankRankEditorMenu {
    ...
    public static void openForPlayer(ServerPlayerEntity player) {
        ...
        inventory.setStack(10, GuildBankRankEditorMenu.rankItem("Guild Master", Items.NETHER_STAR));
        inventory.setStack(12, GuildBankRankEditorMenu.rankItem("Officer", Items.GOLD_INGOT));
        inventory.setStack(14, GuildBankRankEditorMenu.rankItem("Member", Items.ORANGE_DYE));
        inventory.setStack(16, GuildBankRankEditorMenu.rankItem("Initiate", Items.IRON_INGOT));
